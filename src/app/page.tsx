    ...
    <>
      <MaxWidthWrapper className='mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center'>
        ...
        <p className='mt-5 max-w-prose text-zinc-700 sm:text-lg'>
          PageTalker allows you to have conversations with any
        ...
        <div className='relative isolate'>
          <div
            ...
            <div
              ...
              className='aspect-[1155/678] rotate-[30deg] bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]'
            />
          </div>
      ...
      {/* Feature section */}
      <div className='mx-auto mb-32 mt-20 max-w-5xl sm:mt-50'>
        ...
        <ol className='my-6 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0'>
          ...
          <li className='md:flex-1'>
            <div className='flex flex-col space-y-2 border-l-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4'>
              ...
              <span className='mt-2 text-zinc-700'>
                It&apos;s that simple. Try out PageTalker today -
